    ...
    <div class="auth-wrapper">
        <div class="auth-content">
            ...
            <div class="auth-container">
                <h2 style="font-size: xx-large; font-weight: bolder; margin-bottom:20px;" class="text-center">Bamesa Login</h2>
                <form wire:submit="login">
                    <label class="auth-label" for="name">Email: </label>
                    <input type="email" class="auth-input" wire:model="email" placeholder="Email address" required>
                    <label class="auth-label" for="name">Password: </label>
                    <input type="password" class="auth-input" wire:model="password" placeholder="Password" required>
